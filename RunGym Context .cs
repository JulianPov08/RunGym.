...
namespace MicroServiceCRUD.Repositories
{
    public class RunGym : DbContext
    {
        ...
        private void EntityConfuguration(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuarios>().Property(u => u.PeseoDeseado).HasColumnName("PesoDeseado");
            ...
            modelBuilder.Entity<URutinasEjercicio>().Property(u => u.NombreRutina).HasColumnName("NombreRutina");
